...
xterm -e "gdb --args ../basictv --print_level 0 --throw_level 7 --audio false --video false --net_interface_ip_tcp_port 58487 --console_port 59001 --data_folder TEST_DATA_1 --net_proto_ip_tcp_bootstrap_ip 127.0.0.1 --net_proto_ip_tcp_bootstrap_port 58486" &
xterm -e "gdb --args ../basictv --print_level 0 --throw_level 7 --audio false --video false --net_interface_ip_tcp_port 58488 --console_port 59002 --data_folder TEST_DATA_2 --net_proto_ip_tcp_bootstrap_ip 127.0.0.1 --net_proto_ip_tcp_bootstrap_port 58486" &
xterm -e "gdb --args ../basictv --print_level 0 --throw_level 7 --audio false --video false --net_interface_ip_tcp_port 58489 --console_port 59003 --data_folder TEST_DATA_3 --net_proto_ip_tcp_bootstrap_ip 127.0.0.1 --net_proto_ip_tcp_bootstrap_port 58486" &
xterm -e "gdb --args ../basictv --print_level 0 --throw_level 7 --audio false --video false --net_interface_ip_tcp_port 58490 --console_port 59004 --data_folder TEST_DATA_4 --net_proto_ip_tcp_bootstrap_ip 127.0.0.1 --net_proto_ip_tcp_bootstrap_port 58486" &
